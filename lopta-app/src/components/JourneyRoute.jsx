      ...
      <div className="w-full max-w-2xl">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="flex flex-col items-center justify-center mb-4">
            ...
            <select id="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-green-500 focus:border-green-500 block w-28 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
